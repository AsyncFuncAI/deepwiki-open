...
exports.AIModelClientFactory = exports.AzureClient = exports.OllamaClient = exports.MoonshotClient = exports.ZhipuClient = exports.GoogleClient = exports.QwenClient = exports.DeepSeekClient = exports.OpenAIClient = exports.AIModelClient = void 0;
...
exports.AIModelClient = AIModelClient;
/**
 * OpenAI 客户端
 */
 ...
 * DeepSeek 客户端
 */
class DeepSeekClient extends AIModelClient {
    async generateResponse(prompt) {
        const apiKey = this.config.apiKey;
 ...
 * Qwen 客户端
 */
class QwenClient extends AIModelClient {
    async generateResponse(prompt) {
        const apiKey = this.config.apiKey;
        const model = this.config.model || 'qwen-turbo';
        const baseUrl = this.config.baseUrl || 'https://dashscope.aliyuncs.com/api/v1';
        try {
            const response = await (0, node_fetch_1.default)(`${baseUrl}/services/aigc/text-generation/generation`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${apiKey}`
 ...
 * Google Gemini 客户端
 */
class GoogleClient extends AIModelClient {
    async generateResponse(prompt) {
        const apiKey = this.config.apiKey;
        const model = this.config.model || 'gemini-pro';
        const baseUrl = this.config.baseUrl || 'https://generativelanguage.googleapis.com/v1beta';
        try {
            const response = await (0, node_fetch_1.default)(`${baseUrl}/models/${model}:generateContent?key=${apiKey}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
 ...
 * Zhipu 客户端
 */
class ZhipuClient extends AIModelClient {
    async generateResponse(prompt) {
        const apiKey = this.config.apiKey;
 ...
 * Moonshot 客户端
 */
class MoonshotClient extends AIModelClient {
    async generateResponse(prompt) {
        const apiKey = this.config.apiKey;
 ...
 * Ollama 客户端
 */
class OllamaClient extends AIModelClient {
    async generateResponse(prompt) {
        const model = this.config.model || 'llama2';
        const baseUrl = this.config.baseUrl || 'http://localhost:11434';
        try {
            const response = await (0, node_fetch_1.default)(`${baseUrl}/api/generate`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
 ...
 * Azure OpenAI 客户端
 */
class AzureClient extends AIModelClient {
    async generateResponse(prompt) {
        const apiKey = this.config.apiKey;
        const model = this.config.model || 'gpt-4';
        ...
        try {
            const response = await (0, node_fetch_1.default)(`${baseUrl}/openai/deployments/${model}/chat/completions?api-version=2023-12-01-preview`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'api-key': apiKey
...
exports.AIModelClientFactory = AIModelClientFactory;
//# sourceMappingURL=AIModelClient.js.map