...
interface ModelSelectionModalProps {
  ...
  repositoryType?: 'github' | 'gitlab' | 'bitbucket' | 'azure_devops';
  // Authentication
...
export default function ModelSelectionModal({
  ...
  const [localSelectedPlatform, setLocalSelectedPlatform] = useState<'github' | 'gitlab' | 'bitbucket' | 'azure_devops'>(repositoryType);
