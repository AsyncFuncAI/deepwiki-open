...
interface AskModelSelectorProps {
  localOllama: boolean;
...
export default function AskModelSelector({
  localOllama,
  setLocalOllama,
  useOpenRouter,
  setUseOpenRouter,
  ...
  deepResearch,
  setDeepResearch
}: AskModelSelectorProps) {
  const { messages: t } = useLanguage();

  return (
    <div className="bg-[var(--card-bg)] border border-[var(--border-color)] rounded-md p-4 shadow-sm">
      <div className="flex flex-col gap-4">
        <div className="space-y-2">
          <div className="flex items-center">
            ...
            />
            <label htmlFor="deep-research" className="ml-2 text-sm text-[var(--foreground)]">
              {t.ask?.deepResearch || 'Deep Research'}
            </label>
          </div>
          ...
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 rounded border-[var(--border-color)] text-[var(--accent-primary)] focus:ring-[var(--accent-primary)]"
            />
            <label htmlFor="local-ollama-ask" className="ml-2 text-sm text-[var(--foreground)]">
          ...
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 rounded border-[var(--border-color)] text-[var(--accent-primary)] focus:ring-[var(--accent-primary)]"
            />
            <label htmlFor="use-openrouter-ask" className="ml-2 text-sm text-[var(--foreground)]">
          ...
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 rounded border-[var(--border-color)] text-[var(--accent-primary)] focus:ring-[var(--accent-primary)]"
            />
            <label htmlFor="use-openai-ask" className="ml-2 text-sm text-[var(--foreground)]">
        ...
        {useOpenRouter && (
          <div className="w-full">
            <label htmlFor="openrouter-model-ask" className="block text-xs font-medium text-[var(--foreground)] mb-1.5">
              {t.form?.openRouterModel || 'OpenRouter Model'}
            </label>
            <select
              id="openrouter-model-ask"
        ...
        {useOpenai && (
          <div className="w-full">
            <label htmlFor="openai-model-ask" className="block text-xs font-medium text-[var(--foreground)] mb-1.5">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 rounded border-[var(--border-color)] text-[var(--accent-primary)] focus:ring-[var(--accent-primary)]"
                />
                <label htmlFor="use-custom-model-ask" className="ml-2 text-xs text-[var(--muted)]">
        ...
        <div className="flex justify-end space-x-2 mt-4">
          <button
            onClick={onCancel}
            className="px-3 py-1.5 text-sm font-medium rounded-md bg-[var(--button-secondary-bg)] text-[var(--button-secondary-text)] hover:bg-[var(--button-secondary-bg-hover)]"
          >
            {t.repoPage?.cancel || 'Cancel'}
          </button>
          <button
            onClick={onConfirm}
            className="px-3 py-1.5 text-sm font-medium rounded-md bg-[var(--button-primary-bg)] text-[var(--button-primary-text)] hover:bg-[var(--button-primary-bg-hover)]"
          >
            {t.ask?.askButton || 'Ask'}
          </button>
        </div>
